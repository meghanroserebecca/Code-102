"console.log is a link to developers' console tool - which can be accessed through browser tools - not something that consumers will see or interact with in any way"
"". period / comma
, comma
